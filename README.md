Select2
=======
This is a fork of [select2](https://github.com/select2/select2) with improved accessibility after cherry-picking commits from [selectWoo](https://github.com/woocommerce/selectWoo) library.
